...
"https://agcrump.files.wordpress.com/2012/12/"
+"the-hobbit-part-1-an-unexpected-journey-2012-movie-poster-e1348339281255.jpg",
...
hobbit_2 = media.Movie("The Hobbit: The Desolation of Smaug (2013)",
 "https://vignette3.wikia.nocookie.net/lotr/images"
+"/f/f8/The-hobbit-the-desolation-of-smaug-poster.jpg/"
+"revision/latest?cb=20140227201637",
...
the_lord_of_the_rings_2 = media.Movie("The Lord of the Rings: The Two Towers (2002)",
 "http://saint-epondyle.net/blog/wp-content"
 +"/uploads/2012/12/clemburtonlesdeuxtours.jpg",
...
the_lord_of_the_rings_3 = media.Movie("The Lord of the Rings: The Return of the King (2003)",
 ...
 +"8e/77/c3/8e77c3ceeede5d63ee0bfdc19408565b.jpg",
"https://www.youtube.com/watch?v=r5X-hFf6Bwo")

#this creats an object of the Movie class and it contains info of "saving private ryan" movie
saving_private = media.Movie("Saving Private Ryan (1998)",
 "http://is5.mzstatic.com/image/thumb/Video/v4/"
...
+"_V1_UY1200_CR87,0,630,1200_AL_.jpg",
"https://www.youtube.com/watch?v=4O-sMh_DO6I")


#this object holds info for the the "fury" movie
...
#this object holds info for the "shawshank redemption" movie
...
#this object holds info for "mouse hunt" movie
mouse_hunt = media.Movie("Mousehunt (1997)",
"https://images-na.ssl-images-amazon.com/images/"
+"M/MV5BMzE0NTRhZWQtZmE5OS00NTI5LWJhMzMtMGU4MzE4MmRlZDE0"
+"L2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@"
+"._V1_UY1200_CR92,0,630,1200_AL_.jpg",
"https://www.youtube.com/watch?v=zgjUMHGjO0k")


#this object holds info for the "braveheart" movie
braveheart = media.Movie("Braveheart (1995)",
"https://www.movieposter.com/posters/archive/main/70/MPW-35017"
, "https://www.youtube.com/watch?v=wj0I8xVTV18")


#this object holds info for the "fault in our stars" movie
the_fault_in_our_stars = media.Movie("The Fault in Our Stars (2014)",
"https://i.pinimg.com/736x/1b/af/9a/"
+"1baf9a7f2f5465428a5746f6b0eec4c7--star-crossed-hazel-and-augustus.jpg",
"https://www.youtube.com/watch?v=9ItBvH5J6ss")


#this object holds info for the "me before you" movie
...
#this object holds info for the "collatral beauty" movie
...
#this list holds all Movie objects we have created
...
#this method takes the movie list as a parameter and displays them
